...
## 6. Как посмотреть встроенную документацию
- В корне проекта откроете терминал и введите эту команду 
```bash
uvicorn app.main:app --reload --port 8000
```
- Откройте браузер
- Вставьте в поиск этот URL '[text](http://127.0.0.1:8000/api/v1/docs#/)'
- Теперь вы можете сами пощупать эндпоинты и проверить их.
